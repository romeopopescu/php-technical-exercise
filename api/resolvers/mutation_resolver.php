...
/**
 * Base class for every GraphQL Mutation resolver. Each Mutation field has its own
 * concrete subclass under resolvers/mutation/, mirroring Totara's per-operation
